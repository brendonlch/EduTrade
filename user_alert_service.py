...
import os
import csv
from user import UserCorrelation, User, Holdings, get_user_by_id
...
def receive_email_request():
    ...
    channel.queue_bind(exchange=exchangename, queue=replyqueuename, routing_key="alerting.info") # make sure the reply_to queue is bound to the exchange
...
def processRequest(data):
    print("Processing an email request:")
    print(data)
    user = get_user_by_id(data['username'])
...
if __name__ == "__main__":
    print("This is " + os.path.basename(__file__) + ": listening for email request from alert...")
